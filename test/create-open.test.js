  ...
  describe(`orbit-db - Create & Open (${API})`, function() {
    ...
    describe('Open', function() {
      ...
      it('opens a database and adds the creator as the only writer', async () => {
        ...
        assert.equal(db.acl.capabilities.write.length, 1)
        assert.equal(db.acl.capabilities.write[0], db.key.getPublic('hex'))
      })
